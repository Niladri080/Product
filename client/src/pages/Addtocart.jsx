...
const Addtocart = ({ activeSection, setActiveSection }) => {
  ...
  useEffect(() => {
    ...
    axios
      .post(
        "http://localhost:4000/api/dashboard/get-cart",
        { user_id: user._id },
  ...
  const removeItem = (id) => {
    axios
     .post(
        "http://localhost:4000/api/dashboard/delete-cart",
        { user_id: user._id, product_id: id },
        { withCredentials: true }
      )
     .then((res) => {
        if (res.data.success) {
  ...
  const postOrder=()=>{
    ...
    axios
     .post(
        "http://localhost:4000/api/dashboard/create-order",
        { user_id: user._id, products:cart },
        { withCredentials: true }
      )
     .then((res) => {
        if (res.data.success) {
          toast.success(res.data.message);
          navigate(`/user/dashboard/checkout/${res.data.orderId}`);
        } else {
          toast.warning(res.data.message);
        }
      })
