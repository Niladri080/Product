      ...
      {!loading && (
        <div className="signup-bg">
          <div className="signup-card">
            <h2 className="signup-title">Login as {activePage==='admin'?"Admin":"User"} </h2>
            <div
              style={{
                display: "flex",
            ...
            {activePage==='admin' && <AdminLogin loading={loading} setloading={setloading}/>}
            {activePage==='user' &&  <UserLogin loading={loading} setloading={setloading}/>}
          </div>
        </div>
      )}
    </>
